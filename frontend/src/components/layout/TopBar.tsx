        ...
        {tenants.length > 0 && (
          <div className="relative group/select">
            <select
              ...
              className="appearance-none bg-white/5 border border-white/10 text-slate-300 text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl py-2 pl-4 pr-10 focus:outline-none focus:border-indigo-500/50 transition-all cursor-pointer hover:bg-white/10"
            >
              {tenants.map((m) => (
      ...
      <div className="flex items-center gap-2">
        {isSuperuser && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 hover:bg-indigo-500/20 transition-all text-[9px] font-black uppercase tracking-widest"
          >
        ...
        <button
          onClick={onLogout}
          className="p-2.5 rounded-2xl bg-red-500/10 text-red-400 border border-red-500/20 hover:bg-red-500/20 transition-all group/logout"
        >
